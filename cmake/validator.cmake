set(VALIDATOR_EXEC "ccsds_validator")

message(STATUS "Building: ${VALIDATOR_EXEC}")

# Collect all source files for the encoder executable
set(ENCODER_SOURCES
    "${SOURCE_DIR}/exec_validator.cpp"
...
add_executable(${VALIDATOR_EXEC} ${ENCODER_SOURCES} ${DECODER_HEADERS})

# Add include directories to the encoder target
target_include_directories(${VALIDATOR_EXEC} PRIVATE ${INCLUDE_DIR})

# Link the encoder executable with the library
target_link_libraries(${VALIDATOR_EXEC} PRIVATE ${LIB_NAME})

# Set the output directory for the encoder executable
set_target_properties(${VALIDATOR_EXEC} PROPERTIES
...
install(TARGETS ${VALIDATOR_EXEC}
