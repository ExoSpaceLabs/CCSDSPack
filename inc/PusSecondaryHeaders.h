...
namespace ccsds::pus {
  ...
  /** @brief Common base for standards-defined PUS headers. */
  ...
  /** @brief Common PUS telecommand fields. Direction is intrinsic. */
  ...
  /** @brief Common PUS telemetry fields. Direction is intrinsic. */
  ...
  public:
    ...
    [[nodiscard]] std::uint8_t getDestinationIdOctets() const noexcept {
      return m_destinationIdOctets;
    }
    [[nodiscard]] bool timestampPresent() const noexcept { return m_timestampPresent; }
    [[nodiscard]] const time::CucConfiguration &getCucConfiguration() const noexcept {
      return m_cuc;
    }
  ...
  namespace rev_a {
    ...
    public:
      ...
      explicit TmHeader(TmTailoring tailoring, std::uint8_t serviceType = 0U,
                        ...
                        std::uint8_t packetSubcounter = 0U,
                        std::uint32_t destinationId = 0U,
                        time::CucTime timestamp = {});

      [[nodiscard]] Revision getRevision() const noexcept override { return RevisionValue; }
      [[nodiscard]] std::uint8_t getPacketSubcounter() const { return m_packetSubcounter; }
      [[nodiscard]] bool packetSubcounterPresent() const noexcept {
        return m_packetSubcounterPresent;
      }
