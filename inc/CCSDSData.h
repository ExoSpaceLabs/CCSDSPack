...
namespace CCSDS{
    ...
    public:
        ...
        uint16_t getDataFieldAbsoluteSizeByes() const { return m_dataPacketSize; }
        uint16_t getDataFieldUsedSizeByes() const;
        uint16_t getDataFieldAvailableSizeByes() const;
