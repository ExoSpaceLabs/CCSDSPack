...
- NUCLEO-H755ZI-Q Cortex-M7 execution:
  ...
  - packet generation, parsing, CRC, Manager, Validator, PVN, and Idle tests passed;
...
After tagging, the generated packages and container images must still be downloaded or pulled and verified against the selected release commit.

See `CHANGELOG.md` for the complete categorized change list, `CCSDS_COMPLIANCE.md` for clause-level traceability, and `docs/CCSDS_133_0_B_2_PROFILE.md` for the precise protocol profile.
